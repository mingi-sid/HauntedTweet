...
class UnparserTest(unittest.TestCase):
    def test_Unparser_stats(self):
        ...
        "('<go>', 'Token')	('일단', 'Noun')	('아', 'Exclamation')	('무', 'Noun')	('상관', 'Noun')	('없지', 'Adjective')	('만', 'Eomi')	('이', 'Determiner')	('거', 'Noun')	('보고', 'Noun')	('갑', 'Verb')	('시', 'PreEomi')	('다', 'Eomi')	('<eos>', 'Token')	('추가', 'Noun')	('<eos>', 'Token')".split('\t'),
